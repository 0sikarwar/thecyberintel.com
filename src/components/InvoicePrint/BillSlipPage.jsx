    ...
    <div id="tax invoice_2_7105" className="ht-100vh" style={{ paddingTop: "15vh" }}>
      <table border={0} cellPadding={0} cellSpacing={0} className="fs-12pt wt-90vw">
        <colgroup>
          ...
          <col className="fs-12pt" width={69} />
          <col className="fs-12pt" width={55} />
          <col className="fs-12pt" width={92} />
          <col className="fs-12pt" width={108} />
          <col className="fs-12pt" width={50} />
          <col className="fs-12pt" width={64} />
          <col className="fs-12pt" width={71} />
        </colgroup>
        <tbody>
          <tr height={10}>
            <td colSpan={8} height={10} className="fs-12pt bt-1 bb-1 br-0 bl-0" width={589}>
              &nbsp;
            </td>
          </tr>
          <tr height={23}>
          ...
          <tr height={27}>
            <td colSpan={8} height={27} className="fs-12pt border-1 t-left v-middle ">
          ...
          <tr height={29}>
            <td colSpan={3} height={29} className="fs-12pt border-1 t-left v-middle ">
              Name:<span></span>
            </td>
            <td colSpan={3} className="fs-12pt border-1 t-left v-middle bl-0">
              Signature:
            </td>
            <td colSpan={2} className="fs-12pt border-1 t-left v-middle bl-0">
              Date:
            </td>
          </tr>
          <tr height={9}>
          ...
          <tr height={45}>
            <td colSpan={2} height={45} className="fs-12pt fw-bolder border-1 t-left v-top ">
              Client Code: {companyData.id}
            </td>
            <td colSpan={4} className="fs-12pt border-1 fw-bolder bl-0" width={305}>
              Invoice No: {invoiceNumber}
              <span className="px-5"> </span>Invoice Date: {invoiceDate}
              <br />
              Net Amount: {"₹ " + totalWithTax}
            </td>
            <td colSpan={2} className="fs-12pt fw-bolder border-1 t-left v-top bl-0">
              Due Date: {dueDate}
            </td>
          </tr>
          <tr height={30}>
            <td colSpan={8} height={30} className="fs-12pt border-1 fw-bolder v-middle">
              Client Name: {companyData.company_name}
            </td>
          </tr>
          <tr height={62}>
            <td colSpan={4} height={62} className="fs-12pt border-1 fw-bolder" width={296}>
              Name of the Receiver
              <br />
              Received Date
            </td>
            <td colSpan={4} className="fs-12pt fw-bolder border-1 t-left v-top bl-0">
              Sign &amp; Seal
            </td>
          </tr>
          <tr height={9}>

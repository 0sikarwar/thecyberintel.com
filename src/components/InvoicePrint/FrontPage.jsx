  ...
  return (
    <div id="Book1_17204" align="center" className="ht-100vh" style={{ paddingTop: "4vh" }}>
      ...
      >
        ...
        <tbody>
          <tr height={22}>
            <td colSpan={4} height={22} className="bt-1 bb-1 bl-0 br-0 t-center v-middle fs-12pt fw-bolder" width={684}>
              TAX INVOICE
            </td>
          </tr>
          <tr height={22}>
            <td rowSpan={15} height={352} className="border-1 fs-12pt pl-8 v-top" width={293}>
              TO <br />
            ...
            <td colSpan={2} className="br-1 bb-1 bl-0 bt-1 fs-11pt pl-8">
              Invoice Period
            </td>
            <td className="br-1 bb-1 bl-0 bt-1 fs-11pt t-right pr-8">{`${props.fromDate} to ${props.toDate}`}</td>
          </tr>
          {Object.keys(billBreakup).map((key) => (
            <tr height={22} className={highlightedText.includes(key) ? "fw-bolder" : ""}>
              <td colSpan={2} height={22} className="br-1 bb-1 bl-0 bt-1 fs-11pt pl-8">
                {key}
              </td>
              <td className="br-1 bb-1 bl-0 bt-1 fs-11pt t-right pr-8">{billBreakup[key]}</td>
            </tr>
          ))}
          <tr height={45}>
            <td colSpan={4} height={30} className="fs-11pt">
          ...
          <tr height={291}>
            <td colSpan={2} height={291} className="bt-1 bb-1 bl-0 br-1 px-1" width={468}>
              <font className="fs-11pt fw-bolder">
                Statutory Guidelines
                <br />
              </font>
              <font className="fs-11pt ">
